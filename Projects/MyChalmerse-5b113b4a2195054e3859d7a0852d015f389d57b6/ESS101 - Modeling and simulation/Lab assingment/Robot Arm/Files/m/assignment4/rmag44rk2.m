...
% Step Size 0.01
h1 = 0.01;
[y11, y12, t1] = rmag44fRK2(h1);
% Step Size 0.05
h2 = 0.05;
[y21, y22, t2] = rmag44fRK2(h2);
% Step Size 0.08
h3 = 0.08;
[y31, y32, t3] = rmag44fRK2(h3);
...
l = legend('Original', 'h=0.01', 'h=0.05', ...
       'Location', 'northoutside', 'Orientation', 'horizontal');
title(l, 'RK2 Method in Different Step Size')
axis([0 10 0 1.2]);
set(gca, 'FontSize', 18);
...
legend('h=0.08',  'Location', 'southwest')
set(gca, 'FontSize', 18);
