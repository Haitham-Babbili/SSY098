...
% Step Size 0.01
h1 = 0.01;
[y11, y12, t1] = rmag41fFE(h1);
% Step Size 0.04
h2 = 0.04;
[y21, y22, t2] = rmag41fFE(h2);
% Step Size 0.05
h3 = 0.05;
[y31, y32, t3] = rmag41fFE(h3);
...
title(l, 'Forward Euler Method in Different Step Size')
axis([0 10 0 1.2]);
set(gca, 'FontSize', 18);
...
legend('h=0.05',  'Location', 'southwest')
set(gca, 'FontSize', 18);
