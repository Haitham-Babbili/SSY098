...
%% Load Data
% church_data.mat consists of 18578 descriptors, as well as labels and
...
for i = 1 : imgs_num
    ...
    % Read image in folder, convert the image into grayscale
...
fprintf(['%d churches are recognized correctly,\n%d images in total.\n'...
         'Accuracy is %.2f%%.\n\n'],...
