...
% Split training set into training and validation set with ratio 75/25
images_Tr = x(:,1:0.75*size(x,2));               % Training images              
labels_Tr = t(1:0.75*size(t,1),1);               % Training labels

images_Val = x(:,1:0.25*size(x,2));              % Validation images
labels_Val = t(1:0.25*size(t,1),1);              % Validation labels
