...
% Function computes the essential matrix E from P1 and P2, which are the
...
% Transform so that one is right side up and not translated
t=-R2*R1'*t1-t2;
R=R2*R1';

% A cross product form of translation
tx=[0 -t(3) t(2);
    t(3) 0 -t(1);
    -t(2) t(1) 0];
