...
convolution2dLayer(3, 20, 'Padding',1); %Introduce more layers
batchNormalizationLayer;   
reluLayer();
maxPooling2dLayer(2,'Stride', 2);
...
convolution2dLayer(3, 10, 'Padding',1); %Introduce more layers
batchNormalizationLayer;   
reluLayer();
maxPooling2dLayer(2,'Stride', 2);
...
%%
load dataa.mat
[C,scores] =semanticseg(testImage,seg.net,'MiniBatchSize',32);
