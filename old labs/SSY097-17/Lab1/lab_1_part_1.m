...
% The image set in digits.mat has 100 training image and 50 validation
% image, all images have the same size in grayscale and lack of descriptors
% the scale of each image is 20 x 20
load digits.mat
